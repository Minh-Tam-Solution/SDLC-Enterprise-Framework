...
Cross-platform AI agent templates for SDLC 6.3.0 compliance. This folder serves as the primary location for AI assistant configuration templates.
...
> **Note**: Tool-specific templates archived per SDLC 6.3.0 principle - Framework provides universal patterns, not tool-specific configs.
