...
**Structure**: SDLC 6.1.0 (2-level maximum)

---

## Overview

Cross-platform AI agent templates for SDLC 6.1.0 compliance. This folder serves as the primary location for AI assistant configuration templates.
...
Tool-specific templates have been archived to:
...
> **Note**: Tool-specific templates archived per SDLC 6.1.0 principle - Framework provides universal patterns, not tool-specific configs.

---

## Related Documents

For current AI governance guidance:
