...
# SDLC 5.2.0 Custom Rules
custom_rules:
  - name: "Zero Mock Policy"
    pattern: "mock|stub|fake|dummy"
    severity: "critical"
    message: "SDLC 5.2.0 Zero Mock Policy - Use real implementations"

  - name: "Performance Target"
    pattern: "response|latency"
    check: "<50ms"
    severity: "high"
    message: "SDLC 5.2.0 requires <50ms response time"
  ...
  # SDLC 5.2.0: File Naming Standards (restored from 4.3/4.4)
