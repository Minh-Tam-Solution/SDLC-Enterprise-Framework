...
```yaml
System Prompt:
  You are an ADR writer following SDLC 5.2.0 standards.
...
```yaml
System Prompt:
  You are generating team communication protocols following SDLC 5.2.0 standards.
...
```yaml
System Prompt:
  You are generating escalation paths following SDLC 5.2.0 4-level framework.
