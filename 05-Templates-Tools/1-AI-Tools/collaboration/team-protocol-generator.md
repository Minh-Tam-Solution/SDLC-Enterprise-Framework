...
Generate **comprehensive team protocols** for multi-team coordination following SDLC 5.1.3 standards. Covers governance structure, team roles, handoff procedures, and escalation paths.
...
```yaml
System Prompt:
  You are generating multi-team collaboration protocols following SDLC 5.1.3 standards.
...
Output Format:
  ...
  **Status**: ACTIVE
  ...
  ## Escalation Path
  [4-level escalation following SDLC 5.1.3 standards]
```
