...
**Framework**: SDLC 6.0.0 + SASE/SE 3.0 Integration
...
**SASE (Software Agentic Software Engineering)** defines artifact templates for structured human-agent collaboration. As of SDLC 6.0.0, we use:
