...
## Backup Templates for SDLC 6.0.3 (Use When AI Unavailable)
...
**Structure**: SDLC 6.0.3 (2-level maximum, files prefixed by category)
**AI Governance**: Aligned with [03-AI-GOVERNANCE/](../../03-AI-GOVERNANCE/) principles
**Recommendation**: Use [/02-AI-Tools/](../02-AI-Tools/) first (96% faster)

---

## 🎯 SDLC 6.0.3 Integration
...
| 02-09 | Other Stages | See AI Tools | [/02-AI-Tools/](../02-AI-Tools/) |
...
## 📂 Directory Structure (SDLC 6.0.3 Flattened)

```
06-Manual-Templates/
├── README.md                                   # This file
├── Design-Thinking-Empathy-Map-Canvas-Template.md
├── Design-Thinking-User-Journey-Map-Template.md
├── Design-Thinking-Feedback-Analysis-Template.md
├── Design-Thinking-POV-Statement-Template.md
├── Design-Thinking-HMW-Questions-Worksheet.md
├── Design-Thinking-Problem-Statement-Template.md
├── Design-Thinking-Ideation-Brainstorming-Template.md
├── Design-Thinking-Prototype-Test-Plan-Template.md
└── Design-Thinking-User-Testing-Script-Template.md

(Files previously in design-thinking/ subfolder, flattened for 2-level maximum)

Phase 1: Empathize (Stage 00)
  - Design-Thinking-Empathy-Map-Canvas-Template.md     # 8 hours (AI: 20 min)
...
- **AI Tools**: [/02-AI-Tools/](../02-AI-Tools/) - 96% time savings
- **Design Thinking AI**: [/02-AI-Tools/design-thinking/](../02-AI-Tools/design-thinking/)
...
- **SDLC 6.0.3 Overview**: [/01-Overview/](../../01-Overview/)
...
**Folder Status**: BACKUP - SDLC 6.0.3 Complete
