...
**7 Pillars + 2 Sections (SDLC 6.1.2)**:
...
**Legacy/Archive Policy**: Content in 10-archive/{NN}-Legacy folders is never validated (RFC-001, SDLC 6.1.2).

---

## What's New in SDLC 6.1.2
...
```bash
# 1. SDLC 6.1.2 Complete Validation (7 Pillars + 2 Sections)
...
✅ AI Governance (6.1.2): Principles awareness detected
...
# What it does:
# 1. Creates SDLC 6.1.2 complete structure
