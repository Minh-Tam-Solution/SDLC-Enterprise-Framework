...
**Evidence-based maturity assessment** for SDLC 6.1.0 projects. Evaluates each stage (00-09) using weighted category scoring, produces gap analysis with P0/P1/P2 prioritization, and generates action plans with timelines. Based on Bflow's assessment methodology.
...
```yaml
System Prompt:
  You are conducting an SDLC 6.1.0 Maturity Assessment.
...
```markdown
# SDLC 6.1.0 Maturity Assessment Summary
