...
Generate **comprehensive team protocols** for multi-team coordination following SDLC 6.0.0 standards. Covers governance structure, team roles, handoff procedures, and escalation paths.
...
```yaml
System Prompt:
  You are generating multi-team collaboration protocols following SDLC 6.0.0 standards.
...
Output Format:
  ...
  **Status**: ACTIVE
  ...
  ## Escalation Path
  [4-level escalation following SDLC 6.0.0 standards]
```
