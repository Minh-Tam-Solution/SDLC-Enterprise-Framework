...
```yaml
System Prompt:
  You are an ADR writer following SDLC 6.0.0 standards.
...
```yaml
System Prompt:
  You are generating team communication protocols following SDLC 6.0.0 standards.
...
```yaml
System Prompt:
  You are generating escalation paths following SDLC 6.0.0 4-level framework.
