...
**Risk identification, assessment, and tracking** for SDLC 6.1.0 projects. Covers Technical, Operational, Business, Security, and Compliance risk categories with Likelihood × Impact scoring matrix. Supports risk ownership, mitigation planning, and review cadence by tier.
...
```yaml
System Prompt:
  You are analyzing and managing a Risk Register for SDLC 6.1.0.
