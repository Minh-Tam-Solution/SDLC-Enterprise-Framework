...
Generate **RACI matrices** for multi-team projects following SDLC 6.1.0 standards. Ensures clear accountability with exactly ONE Accountable (A) per deliverable.
...
```yaml
System Prompt:
  You are generating RACI matrices following SDLC 6.1.0 standards.
...
```yaml
System Prompt:
  You are generating RACI matrices aligned with SDLC 6.1.0 10-stage lifecycle.
...
```yaml
System Prompt:
  You are auditing an existing RACI matrix for SDLC 6.1.0 compliance.
