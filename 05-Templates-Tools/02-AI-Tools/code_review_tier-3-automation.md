...
# SDLC 6.0.5 Custom Rules
custom_rules:
  - name: "Zero Mock Policy"
    pattern: "mock|stub|fake|dummy"
    severity: "critical"
    message: "SDLC 6.0.5 Zero Mock Policy - Use real implementations"

  - name: "Performance Target"
    pattern: "response|latency"
    check: "<50ms"
    severity: "high"
    message: "SDLC 6.0.5 requires <50ms response time"
  ...
  # SDLC 6.0.5: File Naming Standards (restored from 4.3/4.4)
