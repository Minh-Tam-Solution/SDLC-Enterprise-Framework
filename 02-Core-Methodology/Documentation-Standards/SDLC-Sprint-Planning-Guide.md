...
**Location**: 02-Core-Methodology/Documentation-Standards/ (SDLC 6.0.6 flattened)
...
This guide provides a step-by-step process for planning a new sprint in compliance with SDLC 6.0.6 Sprint Planning Governance.
...
**Owner**: CTO Office
**Version**: 6.0.6 (3-Phase Sprint Model + TDD Integration)
