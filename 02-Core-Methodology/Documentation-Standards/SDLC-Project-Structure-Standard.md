...
This document defines the standard project folder structure for SDLC 6.1.0 compliant projects. It establishes clear separation between:
...
### 10.1 From SDLC 4.x/5.x to 6.1.0
...
[SDLC CLI] migrate --from 5.x --to 6.1.0 --dry-run

# Execute migration
[SDLC CLI] migrate --from 5.x --to 6.1.0
```
