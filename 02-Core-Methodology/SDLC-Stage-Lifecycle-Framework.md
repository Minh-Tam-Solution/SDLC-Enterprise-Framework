...
> Consolidates three 6.1.2 documents into one source of truth.
...
SDLC Framework 6.1.2 defines a **10-stage lifecycle** (00-FOUNDATION through 09-GOVERN) with **quality gates** (G0.1, G0.2, G1, G2, G3, G4) but lacks **explicit documentation** of:
...
```yaml
# SDLC 6.1.2 Stage Dependency Matrix
...
**AI Governance Principles (from SDLC 6.1.2)**:
