...
**NEW in 6.1.1**: Agentic docs moved to 03-AI-GOVERNANCE (#13, #14) + Multi-Agent Patterns (#12) + BRS/MTS→AGENTS.md
...
Define governance, quality, security, and compliance standards that form the **core pillars of SDLC 6.1.1**:
