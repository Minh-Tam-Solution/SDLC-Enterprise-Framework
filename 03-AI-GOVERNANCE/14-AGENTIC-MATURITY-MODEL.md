...
**Framework:** SDLC 6.1.0 (7-Pillar + 2-Section Architecture)
**Version:** 6.1.0
**Date:** February 18, 2026
**Status:** ACTIVE - PRODUCTION READY

> **Terminology Note (6.1.0):** BRS (BriefingScript) and MTS (MentorScript) are
...
> See [DEPRECATION-POLICY.md](../../DEPRECATION-POLICY.md) for migration details.
...
| **1** | Agent-Assisted | Structured human-agent handoff | AGENTS.md, MRP, VCR (3 core) |
| **2** | Structured Agentic | Full SASE artifact workflow | All 4 artifacts + ACE/AEE |
...
┌─────────────┐      ┌─────────────┐      ┌─────────────┐      ┌─────────────┐
│  Copilot    │      │  AGENTS.md  │      │  Full SASE  │      │   Proactive │
...
**Level 1** introduces structured human-agent collaboration with minimum viable SASE artifacts: **AGENTS.md** (project context + conventions), **MRP** (Merge-Readiness Pack), and **VCR** (Version Controlled Resolution).
...
Workflow:
  - AGENTS.md: Human defines project context, conventions, task briefs
  - Agent: Reads AGENTS.md, executes, produces MRP
  - VCR: Human reviews and decides

Artifacts (3 Core):
  ✅ AGENTS.md - Project context + task brief + conventions
  ✅ MRP       - Execution evidence (Merge-Readiness Pack)
  ✅ VCR       - Human decision record (Version Controlled Resolution)
...
SE4H (Human)                                              SE4A (Agent)
     ...
     │     (Context + Conventions + Task Brief)                │
     │  ──────────────────────────────────────────────────────>│
     │                                                         │
     │                                        2. Read AGENTS.md│
     │                                           Execute Task  │
...
Criteria:
  □ AGENTS.md maintained per project              [0-10 pts]
...
Indicators:
  - AGENTS.md: Updated within last 30 days
...
**Level 2** implements the full SASE artifact workflow with all 4 active artifacts and dedicated ACE/AEE environments.
...
AI Usage:
  ...
  - Agent generates execution plans internally
  - Structured consultation (CRP)
  - Project conventions encoded in AGENTS.md

Workflow:
  - AGENTS.md + CRP + MRP + VCR cycle
  - ACE for human command/review
  - AEE for agent execution (sandboxed)

Artifacts (All 4 Active):
  ✅ AGENTS.md - Project context + conventions + task briefs
  ✅ CRP       - Consultation requests (agent asks human)
...
┌─────────────────────────────────────────┼─────────────────────────────────────┐
│                                         │                                     │
│  1. Update AGENTS.md with task brief    │                                     │
│  ───────────────────────────────────────┼────────────────────────────────────>│
│                                         │                                     │
│                                         │  2. Read AGENTS.md (context +       │
│                                         │     conventions)                    │
...
Criteria:
  □ All 4 SASE artifacts in use                [0-15 pts]
...
| **Quality** | AGENTS.md ensures consistency | Code review findings ↓ |
| **Visibility** | Full execution trace | Evidence Vault tracking |
...
```yaml
Prerequisites:
  - Level 1 stable: AGENTS.md/MRP/VCR workflow mature
...
Implementation Steps:
  ...
  3. Add CRP workflow for agent escalation (Week 3-4)
  4. Connect Evidence Vault (Week 4-5)
...
How It Works:
  - Agents remember past AGENTS.md contexts, MRPs, VCRs
...
Implementation:
  ...
  - Embeddings of artifacts (AGENTS.md, MRP, VCR)
...
How It Works:
  ...
  - Suggests tasks for human approval
...
Example:
  Agent: "I noticed 3 endpoints have similar error
          ...
          task brief for this refactoring?"
...
How It Works:
  - Agent learns from multiple project AGENTS.md files
...
Example:
  Agent: "Based on similar past tasks, this task
...
Q1. How do you use AI tools today?
  ...
  c) Structured with AGENTS.md/MRP/VCR (15 pts) → Level 1
...
|-------------|----------------|----------------|
| 0-20 | Level 0: Tool-Assisted | Start with AGENTS.md/MRP/VCR |
| 21-50 | Level 1: Agent-Assisted | Add CRP, deploy ACE/AEE |
...
Quarter 1: Level 0 → Level 1
  ...
  Month 3:
    ...
    - Measure: AGENTS.md freshness, VCR rate
    - Prepare for Level 2
...
Quarter 2-3: Level 1 → Level 2
  ...
  Month 6-7:
    ...
    - Measure: All 4 artifacts, ACE/AEE usage
...
|-------|-------------|--------|
| **Level 1** | AGENTS.md freshness | Updated within 30 days |
| | MRP completeness | >70% with evidence |
| | VCR rate | 100% for merges |
| **Level 2** | 4 artifact usage | 100% adoption |
| | CRP response time | <2h (P1) |
...
Level 2 Governance:
  - AGENTS.md updates: Require PR review
...
|----------|---------|---------|---------|---------|
| AGENTS.md | ❌ | ✅ Required | ✅ Required | ✅ Required |
...
|----------|----------|---------|
| [13-AGENTIC-CORE-PRINCIPLES](./13-AGENTIC-CORE-PRINCIPLES.md) | 03-AI-GOVERNANCE/ | SE4H/SE4A framework + 7 Agentic Principles |
| [12-MULTI-AGENT-PATTERNS](./12-MULTI-AGENT-PATTERNS.md) | 03-AI-GOVERNANCE/ | Multi-Agent orchestration patterns |
| [AGENTS.md Template](../05-Templates-Tools/04-SASE-Artifacts/AGENTS-MD-Template.md) | 05-Templates-Tools/ | AGENTS.md template (replaces BRS/MTS) |
| [CRP Template](../05-Templates-Tools/04-SASE-Artifacts/01-CRP-Template.md) | 05-Templates-Tools/ | Consultation Request Process |
| [MRP Template](../05-Templates-Tools/06-Manual-Templates/SDLC-MRP-Template.md) | 05-Templates-Tools/ | Merge-Readiness Pack |
| [VCR Template](../05-Templates-Tools/04-SASE-Artifacts/03-VCR-Template.md) | 05-Templates-Tools/ | Version Controlled Resolution |
| [ACE-AEE-Reference-Architecture](../07-Implementation-Guides/ACE-AEE-Reference-Architecture.md) | 07-Implementation-Guides/ | Environment specs |
...
|---------|------|--------|---------|
| 6.1.0 | 2026-02-18 | CTO + AI | BRS/MTS/LPS → AGENTS.md terminology, 6→4 active artifacts, L1→L2 transition slimmed (8→6 weeks) |
