# CHANGELOG Archive — v6.x and Earlier

Moved out of the live `CHANGELOG.md` on 2026-09-26 to keep the live tree small; the text below is unmodified and byte-identical to what stood in the live file before the move (see CEO decision 2026-09-26, m116 item #5).
For current (v7+) entries, see the live [`CHANGELOG.md`](../../CHANGELOG.md).
