...
**Framework**: SDLC 5.2.0 + SASE/SE 3.0 Integration
...
**SASE (Software Agentic Software Engineering)** defines artifact templates for structured human-agent collaboration. As of SDLC 5.2.0, we use:
