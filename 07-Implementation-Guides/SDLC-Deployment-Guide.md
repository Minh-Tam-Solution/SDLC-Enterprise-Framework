# SDLC 6.1.1 Deployment Guide - From Zero to Production
...
resource "aws_instance" "app" {
  ...
  user_data = <<-EOF
    #!/bin/bash
    docker run -d -p 80:8000 myapp:6.1.1
  EOF
}
```
...
### Templates & Tools
- [05-Templates-Tools/1-AI-Tools/deployment/](../../05-Templates-Tools/1-AI-Tools/deployment/) - AI deployment prompts
- [05-Templates-Tools/4-Scripts/](../../05-Templates-Tools/4-Scripts/) - Deployment scripts
