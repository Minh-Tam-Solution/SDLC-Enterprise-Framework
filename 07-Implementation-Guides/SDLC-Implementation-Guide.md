# SDLC 6.0.5 Implementation Guide - From Zero to Production
...
Every SDLC 6.0.5 compliant project **MUST** have this documentation structure using **shortened folder names**:
...
**SDLC 6.0.5 uses shortened folder names** (not long descriptive names):
...
Every project implementing SDLC 6.0.5 should have an **SDLC Compliance folder** containing:
...
└── 01-SDLC-Compliance/               # SDLC Context for this project
    ...
    └── FRAMEWORK-SUMMARY.md          # SDLC 6.0.5 summary (optional)
```
...
| `FRAMEWORK-SUMMARY.md` | SDLC 6.0.5 quick reference | Optional |
...
### SDLC 6.0.5 Simplified Artifacts
...
**For teams with existing codebases that want to adopt SDLC 6.0.5 incrementally.**
...
Week 1-4 (Sprint 122-123):
  ...
  - Team allocation: 0% SDLC 6.0.5 work
...
Week 5-8 (Sprint 124-125):
  ...
  - Team allocation: Still 0% SDLC 6.0.5 work
...
**Recommendation:**
For teams new to SDLC 6.0.5, the BFlow "stealth pilot" approach reduces risk by validating templates before team-wide rollout. Consider this approach if:
...
```
SDLC 6.0.5 = 10 Stages + 7 Pillars + Section 7 (QA) + 4 Tiers
