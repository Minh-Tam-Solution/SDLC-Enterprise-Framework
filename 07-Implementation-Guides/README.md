# SDLC 6.1.0 Implementation Guides

**Version**: 6.1.0 | **Status**: PRODUCTION READY | **Date**: February 18, 2026

Practical how-to guides for implementing SDLC 6.1.0 framework + Section 7 Quality Assurance System + **TDD Integration** + **SPEC-0021 Stage Consistency Validation** + **RFC-001 Legacy Organization** + **Anthropic Best Practices**.

**AI Governance**: Aligned with [03-AI-GOVERNANCE/](../03-AI-GOVERNANCE/) principles
**NEW in 6.1.0**: Consolidation Release — Ring 1 Slim, Multi-Agent Patterns, System Thinking + Crisis-to-Pattern foundations
...
Start fresh with SDLC 6.1.0 from day one.
...
Adopt SDLC 6.1.0 incrementally into running projects.
...
|-------|---------|----------|
| **SDLC-Implementation-Guide.md** | Complete SDLC 6.1.0 deployment | Starting from scratch (greenfield) |
...
### Legacy/Archive Structure (SDLC 6.1.0 - RFC-001)

```yaml
Rules (RFC-001 - Effective 6.1.0):
...
| Script | Purpose |
|--------|---------|
| `compliance_sdlc_validator.py` | Validate SDLC 6.1.0 folder structure (7-Pillar + 2-Section + TDD) |
