...
|---|---|---|---|
| `v6/02-Core-Methodology/SDLC-Stage-Lifecycle-Framework.md` | PARTIALLY_ADOPTED | [`core/lifecycle.md`](core/lifecycle.md) · [`standards/observability.md`](standards/observability.md) · [`standards/testing.md`](standards/testing.md) · [`core/design-thinking.md`](core/design-thinking.md) | stage dependency YAML matrix, artifact SHA256 integrity per stage, evidence vault |
...
| `v6/03-AI-GOVERNANCE/13-AGENTIC-CORE-PRINCIPLES.md` | PARTIALLY_ADOPTED | [`standards/security.md`](standards/security.md) · [`standards/observability.md`](standards/observability.md) · [`core/systems-thinking.md`](core/systems-thinking.md) | retry logic for flaky tests |
...
Done 2026-09-26: security, testing, change and deployment, observability (four standards); systems thinking and design thinking (`core/`), ship-useful folded into the constitution. Next: SSOT (`v6/02-Core-Methodology/SDLC-SSOT-Principle.md`, `SDLC-Context-Authority-Methodology.md`), integration and data, team collaboration and hand-over.
